...
# ============================================================================
# TEST 2: ARGPARSE OVERRIDES WORK CORRECTLY
# ============================================================================


# class TestArgparseOverrides:
#     """Test that argparse arguments correctly override partial presets"""

#     def test_k_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit k argument overrides partial preset"""
#         # thRNN_5win has k=5 by default
#         kwargs = {**base_architecture_kwargs, "k": 10}
#         net = PredictiveNet(mock_env, pRNNtype="thRNN_5win", hidden_size=100, **kwargs)
#         assert net.pRNN.k == 10, f"Expected k=10 (override), got k={net.pRNN.k}"

#     def test_actOffset_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit actOffset overrides partial preset"""
#         # thRNN_5win_prevAct has actOffset=1 by default
#         kwargs = {**base_architecture_kwargs, "actOffset": 3}
#         net = PredictiveNet(mock_env, pRNNtype="thRNN_5win_prevAct", hidden_size=100, **kwargs)
#         assert net.pRNN.actOffset == 3, f"Expected actOffset=3 (override), got {net.pRNN.actOffset}"

#     def test_continuousTheta_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit continuousTheta overrides partial preset"""
#         # thcycRNN_5win_hold has continuousTheta=False by default
#         kwargs = {**base_architecture_kwargs, "continuousTheta": True}
#         net = PredictiveNet(mock_env, pRNNtype="thcycRNN_5win_hold", hidden_size=100, **kwargs)
#         assert net.pRNN.continuousTheta == True, (
#             f"Expected continuousTheta=True (override), got {net.pRNN.continuousTheta}"
#         )

#     def test_rollout_action_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit rollout_action overrides partial preset"""
#         # thcycRNN_5win_hold has rollout_action="hold" by default
#         kwargs = {**base_architecture_kwargs, "rollout_action": "first"}
#         net = PredictiveNet(mock_env, pRNNtype="thcycRNN_5win_hold", hidden_size=100, **kwargs)
#         assert net.pRNN.rollout_action == "first", (
#             f"Expected rollout_action='first' (override), got {net.pRNN.rollout_action}"
#         )

#     def test_use_FF_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit use_FF overrides partial preset"""
#         # AutoencoderRec has use_FF=False by default
#         kwargs = {**base_architecture_kwargs, "use_FF": True}
#         net = PredictiveNet(mock_env, pRNNtype="AutoencoderRec", hidden_size=100, **kwargs)
#         assert net.pRNN.use_FF == True, f"Expected use_FF=True (override), got {net.pRNN.use_FF}"

#     def test_mask_actions_override(self, mock_env, base_architecture_kwargs):
#         """Test that explicit mask_actions overrides partial preset"""
#         # thRNN_5win has mask_actions=False by default
#         kwargs = {**base_architecture_kwargs, "mask_actions": True}
#         net = PredictiveNet(mock_env, pRNNtype="thRNN_5win", hidden_size=100, **kwargs)
#         assert net.pRNN.mask_actions == True, (
#             f"Expected mask_actions=True (override), got {net.pRNN.mask_actions}"
#         )


# # ============================================================================
# # TEST 3: NONE VALUES DON'T OVERRIDE PARTIALS
# # ============================================================================


# class TestNoneDoesNotOverride:
#     """Test that None values in kwargs don't override partial presets"""

#     def test_k_none_preserves_partial(self, mock_env, base_architecture_kwargs):
#         """Test that k=None doesn't override partial preset"""
#         kwargs = {**base_architecture_kwargs, "k": None}
#         net = PredictiveNet(mock_env, pRNNtype="thRNN_5win", hidden_size=100, **kwargs)
#         assert net.pRNN.k == 5, f"k=None should preserve partial preset (5), got {net.pRNN.k}"

#     def test_continuousTheta_none_preserves_partial(self, mock_env, base_architecture_kwargs):
#         """Test that continuousTheta=None doesn't override partial preset"""
#         kwargs = {**base_architecture_kwargs, "continuousTheta": None}
#         net = PredictiveNet(mock_env, pRNNtype="thcycRNN_5win_holdc", hidden_size=100, **kwargs)
#         assert net.pRNN.continuousTheta == True, (
#             f"continuousTheta=None should preserve partial preset (True), got {net.pRNN.continuousTheta}"
#         )

#     def test_init_none_preserves_partial(self, mock_env, base_architecture_kwargs):
#         """Test that init=None doesn't override lognRNN partial preset"""
#         kwargs = {**base_architecture_kwargs, "init": None}
#         net = PredictiveNet(mock_env, pRNNtype="lognRNN_mask", hidden_size=100, **kwargs)
#         # Can't directly check init, but weights should still be log-normal
#         W_hh = net.pRNN.W.detach().cpu().numpy().flatten()
#         assert W_hh.mean() > 0  # Basic check for log-normal
...
# ============================================================================
# TEST 6: INTEGRATION TESTS (Full Workflow)
# ============================================================================
...
#     def test_train_with_divnorm_trainable(self, mock_env, base_architecture_kwargs):
#         """Test that training works with trainable DivNorm parameters"""
#         kwargs = {
#             **base_architecture_kwargs,
#             "target_mean": 0.7,
#             "k_div": 1.0,
...
#             mock_env,
#             pRNNtype="Masked",
#             hidden_size=50,  # Small for speed
#             cell="DivNormRNNCell",
#             **kwargs,
#         )

#         # Get initial values
#         k_div_initial = net.pRNN.rnn.cell.divnorm.k_div.item()
#         sigma_initial = net.pRNN.rnn.cell.divnorm.sigma.item()

#         # Run a few training steps
#         from prnn.utils.agent import create_agent

#         agent = create_agent("RandomActionAgent", mock_env)

#         # Just run a couple iterations to make sure it doesn't crash
#         for _ in range(2):
#             obs, act, _, _ = net.collectObservationSequence(mock_env, agent, tsteps=50)
#             net.trainStep(obs, act)

#         # Check that parameters changed (they should if trainable)
#         k_div_final = net.pRNN.rnn.cell.divnorm.k_div.item()
#         sigma_final = net.pRNN.rnn.cell.divnorm.sigma.item()

#         # At least one should have changed
#         assert k_div_initial != k_div_final or sigma_initial != sigma_final, (
#             "Trainable DivNorm parameters should change during training"
#         )

#     def test_all_partial_architectures_instantiate(self, mock_env, base_architecture_kwargs):
#         """Smoke test: all partial architectures can be instantiated"""
...
#         for pRNNtype in architectures_to_test:
#             try:
#                 net = PredictiveNet(
#                     mock_env, pRNNtype=pRNNtype, hidden_size=50, **base_architecture_kwargs
#                 )
#                 assert net is not None, f"{pRNNtype} failed to instantiate"
#             except Exception as e:
#                 pytest.fail(f"{pRNNtype} raised exception: {e}")
