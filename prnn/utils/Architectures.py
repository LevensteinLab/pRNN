...
class pRNN(nn.Module):
    ...
    def __init__(
        ...
        **cell_kwargs,
        ...
        with torch.no_grad():
            self.W.add_(
                torch.eye(hidden_size).mul_(1 - 1 / self.neuralTimescale).to_sparse()
            )
    ...
    def create_layers(
        ...
        **cell_kwargs,
        ...
        self.outlayer = nn.Sequential(
            nn.Linear(hidden_size, obs_size, bias=False), nn.Sigmoid()
        )
    ...
    def generate_noise(self, noise_params, shape):
        if noise_params != (0, 0):
            noise = noise_params[0] + noise_params[1] * torch.randn(
                shape, device=self.W.device
            )
        else:
    ...
    def spontaneous(
        ...
        if agent is not None:
            ...
            obs_pred, h_t, _ = self.forward(
                obs, act, noise_t=noise_t, state=state, theta=0
            )
            noise_t = (noise_t, act)
        else:
...
class pRNN_th(pRNN):
    ...
    def restructure_inputs(self, obs, act, batched=False):
        ...
        theta_idx = np.flip(
            toeplitz(np.arange(self.k + 1), np.arange(obs_target.size(1))), 0
        )
        theta_idx = theta_idx[
            :,
            self.k :,
        ...
        if self.actionTheta == "hold":
            ...
            size[0] = self.k + 1
            act = act.expand(*size)
            obs = nn.functional.pad(input=obs, pad=obspad, mode="constant", value=0)

        elif self.actionTheta is True:
            theta_idx = np.flip(
                toeplitz(np.arange(self.k + 1), np.arange(act.size(1))), 0
            )
            theta_idx = theta_idx[
                :,
                self.k :,
...
class pRNN_multimodal(pRNN):
    ...
    def create_layers(
        ...
        **cell_kwargs,
        ...
        self.outlayer = nn.Sequential(
            nn.Linear(hidden_size, output_size, bias=False), nn.Sigmoid()
        )
...
class vRNN(pRNN):
    def __init__(self, obs_size, act_size, hidden_size=500, cell=RNNCell):
...
class vRNN_2win(pRNN):
    def __init__(
        ...
        super(vRNN_2win, self).__init__(
            ...
            predOffset=1,
            actOffset=0,
            inMask=[True, False, False],
            outMask=[True, True, True],
            actMask=None,
        )
...
class vRNN_3win(pRNN):
    def __init__(
        ...
        super(vRNN_3win, self).__init__(
            ...
            predOffset=1,
            actOffset=0,
            inMask=[True, False, False, False],
            outMask=[True, True, True, True],
            actMask=None,
        )
...
class vRNN_4win(pRNN):
    def __init__(
        ...
        super(vRNN_4win, self).__init__(
            ...
            predOffset=1,
            actOffset=0,
            inMask=[True, False, False, False, False],
            outMask=[True, True, True, True, True],
            actMask=None,
        )
...
class vRNN_5win(pRNN):
    def __init__(
        ...
        super(vRNN_5win, self).__init__(
            ...
            predOffset=1,
            actOffset=0,
            inMask=[True, False, False, False, False, False],
            outMask=[True, True, True, True, True, True],
            actMask=None,
        )
...
class vRNN_1win_mask(pRNN):
    def __init__(
        ...
        super(vRNN_1win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class vRNN_2win_mask(pRNN):
    def __init__(
        ...
        super(vRNN_2win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class vRNN_3win_mask(pRNN):
    def __init__(
        ...
        super(vRNN_3win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class vRNN_4win_mask(pRNN):
    def __init__(
        ...
        super(vRNN_4win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class vRNN_5win_mask(pRNN):
    def __init__(
        ...
        super(vRNN_5win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_0win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_0win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_1win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_1win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_2win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_2win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_3win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_3win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_4win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_4win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_5win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_5win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_6win_noLN(pRNN):
    def __init__(
        ...
        super(thRNN_6win_noLN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_0win(pRNN):
    def __init__(
        ...
        super(thRNN_0win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_1win(pRNN):
    def __init__(
        ...
        super(thRNN_1win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_2win(pRNN):
    def __init__(
        ...
        super(thRNN_2win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_3win(pRNN):
    def __init__(
        ...
        super(thRNN_3win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_4win(pRNN):
    def __init__(
        ...
        super(thRNN_4win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_5win(pRNN):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(thRNN_5win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_6win(pRNN):
    def __init__(
        ...
        super(thRNN_6win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_7win(pRNN):
    def __init__(
        ...
        super(thRNN_7win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_8win(pRNN):
    def __init__(
        ...
        super(thRNN_8win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_9win(pRNN):
    def __init__(
        ...
        super(thRNN_9win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_10win(pRNN):
    def __init__(
        ...
        super(thRNN_10win, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_1win_mask(pRNN):
    def __init__(
        ...
        super(thRNN_1win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_2win_mask(pRNN):
    def __init__(
        ...
        super(thRNN_2win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_3win_mask(pRNN):
    def __init__(
        ...
        super(thRNN_3win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_4win_mask(pRNN):
    def __init__(
        ...
        super(thRNN_4win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_5win_mask(pRNN):
    def __init__(
        ...
        super(thRNN_5win_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_0win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_0win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_1win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_1win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_2win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_2win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_3win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_3win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_4win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_4win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_5win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_5win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_6win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_6win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_7win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_7win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_8win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_8win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_9win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_9win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thRNN_10win_prevAct(pRNN):
    def __init__(
        ...
        super(thRNN_10win_prevAct, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderFF(pRNN):
    def __init__(
        ...
        super(AutoencoderFF, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderRec(pRNN):
    def __init__(
        ...
        super(AutoencoderRec, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderPred(pRNN):
    def __init__(
        ...
        super(AutoencoderPred, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderFFPred(pRNN):
    def __init__(
        ...
        super(AutoencoderFFPred, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderFF_LN(pRNN):
    def __init__(
        ...
        super(AutoencoderFF_LN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderRec_LN(pRNN):
    def __init__(
        ...
        super(AutoencoderRec_LN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderPred_LN(pRNN):
    def __init__(
        ...
        super(AutoencoderPred_LN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderFFPred_LN(pRNN):
    def __init__(
        ...
        super(AutoencoderFFPred_LN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderMaskedO(pRNN):
    def __init__(
        ...
        super(AutoencoderMaskedO, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderMaskedOA(pRNN):
    def __init__(
        ...
        super(AutoencoderMaskedOA, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderMaskedO_noout(pRNN):
    def __init__(
        ...
        super(AutoencoderMaskedO_noout, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class AutoencoderMaskedOA_noout(pRNN):
    def __init__(
        ...
        super(AutoencoderMaskedOA_noout, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class thcycRNN_3win(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_3win, self).__init__(
            obs_size,
            act_size,
            k=3,
            hidden_size=hidden_size,
...
class thcycRNN_4win(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_4win, self).__init__(
            obs_size,
            act_size,
            k=4,
            hidden_size=hidden_size,
...
class thcycRNN_5win(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_holdc(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_holdc, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_fullc(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_fullc, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_firstc(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_firstc, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_hold(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_hold, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_full(pRNN_th):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(thcycRNN_5win_full, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_first(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_first, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_holdc_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_holdc_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_fullc_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_fullc_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_firstc_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_firstc_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_hold_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_hold_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_full_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_full_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_first_adapt(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_first_adapt, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_holdc_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_holdc_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_fullc_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_fullc_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_firstc_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_firstc_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_hold_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_hold_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_full_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_full_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class thcycRNN_5win_first_prevAct(pRNN_th):
    def __init__(
        ...
        super(thcycRNN_5win_first_prevAct, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class lognRNN_rollout(pRNN_th):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(lognRNN_rollout, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class lognRNN_mask(pRNN):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(lognRNN_mask, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class vRNN_LayerNorm(vRNN):
    def __init__(
        self, obs_size, act_size, hidden_size=500, nonlinearity="relu", bias=False
    ):
        super(vRNN_LayerNorm, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
...
class thRNN_LayerNorm(thRNN):
    def __init__(
        ...
        super(thRNN_LayerNorm, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            nonlinearity=nonlinearity,
...
class vRNN_LayerNormAdapt(vRNN):
    def __init__(
        ...
        super(vRNN_LayerNormAdapt, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            nonlinearity=nonlinearity,
...
class vRNN_adaptCANN(vRNN):
    def __init__(
        ...
        super(vRNN_adaptCANN, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            nonlinearity=nonlinearity,
...
class vRNN_CANN_FFonly(vRNN_CANN):
    def __init__(
        ...
        super(vRNN_CANN_FFonly, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            nonlinearity=nonlinearity,
...
class vRNN_adptCANN_FFonly(vRNN_adaptCANN):
    def __init__(
        ...
        super(vRNN_adptCANN_FFonly, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            nonlinearity=nonlinearity,
...
class sgpRNN_5win(pRNN_th):
    def __init__(
        ...
        super(sgpRNN_5win, self).__init__(
            obs_size,
            act_size,
            k=5,
            hidden_size=hidden_size,
...
class multRNN_5win_i01_o01(pRNN_multimodal):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(multRNN_5win_i01_o01, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class multRNN_5win_i1_o0(pRNN_multimodal):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(multRNN_5win_i1_o0, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class multRNN_5win_i01_o0(pRNN_multimodal):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(multRNN_5win_i01_o0, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
...
class multRNN_5win_i0_o1(pRNN_multimodal):
    def __init__(
        ...
        **cell_kwargs,
        ...
        super(multRNN_5win_i0_o1, self).__init__(
            obs_size,
            act_size,
            hidden_size=hidden_size,
            cell=cell,
