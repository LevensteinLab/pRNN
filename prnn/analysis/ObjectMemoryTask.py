...
class ObjectMemoryTask:
    ...
    def getTestTrial(
        ...
        obs, act, state, render = pN_post.collectObservationSequence(
    ...
    def ObjectLearningFigure(self, netname=None, savefolder=None, whichview=1):
        ...
        self.exampleObsSequencePanel(
            self.testTrial, self.objectLearning, whichview=whichview
        )
    ...
    def exampleObsSequencePanel(
        self, objectTest, objectLearning, firstrow=3, whichview=1
    ):
